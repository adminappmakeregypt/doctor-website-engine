...
async function addDoctor() {
  ...
  try {
    ...
    await setDoc(doc(db, "websiteDirectory", slug), { clinicId, slug, updatedAt: Date.now() }, { merge: true });
    ...
    ["nName", "nSpec", "nClinicName", "nSlug", "nClinicId", "nPhone", "nWa", "nEmail", "nPass"]
      .forEach((id) => { $(id).value = ""; });
    loadSites();
  } catch (e) {
    say(msg, arabicError(e), "err");
